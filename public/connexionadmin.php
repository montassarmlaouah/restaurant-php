    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-left">
                ...
                <p class="mb-4">Connectez-vous pour gérer votre site.</p>
            ...
            <div class="auth-right">
                <h2 class="mb-3 fw-bold" style="color:var(--primary-blue);">Connexion Admin</h2>
                <p class="text-muted mb-4">Entrez vos identifiants d'administrateur</p>
                ...
                <form method="POST" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="nomd'utilisateur" required>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                  <p class="login-link">Pas encore de compte ? <a href="inscriptionadmin.php">Inscrivez-vous ici</a></p>
            </div>
        </div>
    </div>
